...
async function fetchAppUser() {
  ...
  if (!data) {
    // Триггер handle_new_user мог ещё не завершиться — ждём и пробуем снова
...
async function boot() {
  ...
  try {
    ...
    // Чистим OAuth-хеш из URL (косметически) — SDK уже распарсил сессию
